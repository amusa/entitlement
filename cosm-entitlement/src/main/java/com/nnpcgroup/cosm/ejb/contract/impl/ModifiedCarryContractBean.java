 ...
 */
@Stateless
public class ModifiedCarryContractBean extends AbstractCrudServicesImpl<ModifiedCarryContract> {
    ...
    public ModifiedCarryContractBean() {
        super(ModifiedCarryContract.class);
    }
