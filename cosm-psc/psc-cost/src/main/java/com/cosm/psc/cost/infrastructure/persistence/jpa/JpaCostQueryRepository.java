 ...
 */
package com.cosm.psc.cost.infrastructure.persistence.jpa;
...
import com.cosm.psc.cost.domain.repository.CostQueryRepository;
 ...
 */
@ApplicationScoped
public class JpaCostQueryRepository extends JpaQueryRepository<ProductionCost> implements CostQueryRepository {
    ...
    public JpaCostQueryRepository() {
        super(ProductionCost.class);
    }


    @Override
    public List<ProductionCost> find(Long pscId, Long oilFieldId, Integer year, Integer month) {
    ...
    @Override
    public List<ProductionCost> findOpex(Long pscId, Long oilFieldId, Integer year, Integer month) {
    ...
    @Override
    public List<ProductionCost> findCapex(Long pscId, Long oilFieldId, Integer year, Integer month) {
    ...
    @Override
    public double getCostToDate(Long pscId, Long oilFieldId, Integer year, Integer month) {
        CriteriaBuilder cb = getEntityManager().getCriteriaBuilder();
        ...
        Predicate basePredicate = cb.and(
                ...
                cb.equal(cost.get("oilFieldId"), oilFieldId)
        );
    ...
    @Override
    public double getOpex(Long pscId, Long oilFieldId, Integer year, Integer month) {
    ...
    @Override
    public double getCurrentYearOpex(Long pscId, Long oilFieldId, Integer year, Integer month) {
        CriteriaBuilder cb = getEntityManager().getCriteriaBuilder();
...
//        Predicate yearsPredicate = cb.or(currYrPredicate, priorYrPredicate);
    ...
    @Override
    public double getCapex(Long pscId, Long oilFieldId, Integer year, Integer month) {
        CriteriaBuilder cb = getEntityManager().getCriteriaBuilder();
    ...
    @Override
    public double getCurrentYearCapex(Long pscId, Long oilFieldId, Integer year, Integer month) {
        CriteriaBuilder cb = getEntityManager().getCriteriaBuilder();
...
//        Predicate yearsPredicate = cb.or(currYrPredicate, priorYrPredicate);
    ...
    @Override
    public double getCapitalAllowanceRecovery(Long pscId, Long oilFieldId, Integer year, Integer month) {
        CriteriaBuilder cb = getEntityManager().getCriteriaBuilder();
    ...
    @Override
    public Double getEducationTax(Long pscId, Long oilFieldId, Integer year, Integer month) {
        CriteriaBuilder cb = getEntityManager().getCriteriaBuilder();
    ...
    public boolean fiscalPeriodExists(Long pscId, Long oilFieldId, Integer year, Integer month) {
        List<ProductionCost> prodCosts = find(pscId, oilFieldId, year, month);
    ...
    @Override
    public boolean fiscalPeriodExists(Long pscId, Long oilFieldId, FiscalPeriod fp) {
        return fiscalPeriodExists(pscId, oilFieldId, fp.getYear(), fp.getMonth());
    }
