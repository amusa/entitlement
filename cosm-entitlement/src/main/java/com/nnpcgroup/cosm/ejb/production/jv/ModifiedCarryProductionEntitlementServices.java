 ...
 * @author 18359
 */
public interface ModifiedCarryProductionEntitlementServices extends AlternativeFundingProductionEntitlementServices<ModifiedCarryProductionEntitlement, ModifiedCarryContract> {
