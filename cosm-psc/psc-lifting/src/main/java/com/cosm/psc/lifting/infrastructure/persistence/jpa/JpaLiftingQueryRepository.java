...
import com.cosm.psc.lifting.domain.repository.LiftingQueryRepository;
...
public class JpaLiftingQueryRepository extends JpaQueryRepository<Lifting> implements LiftingQueryRepository {
    ...
    @Override
    public List<Lifting> find(Long pscId, Long oilFieldId, Date fromDate, Date toDate) {
        java.sql.Date fDate = new java.sql.Date(fromDate.getTime());
        java.sql.Date tDate = new java.sql.Date(toDate.getTime());
        ...
        Predicate pscPredicate = cb.and(cb.equal(e.get("pscId"), pscId),
...
//            liftings = query.getResultList();
    ...
    @Override
    public List<Lifting> find(Long pscId, Long oilFieldId, int year, int month) {
        CriteriaBuilder cb = getEntityManager().getCriteriaBuilder();
        Metamodel m = getEntityManager().getMetamodel();
        EntityType<Lifting> Lifting_ = m.entity(entityClass);
    ...
    @Override
    public double computeWeightedAvePrice(Long pscId, Long oilFieldId, int year, int month) {
        ...
        Predicate predicate = cb.and(
                ...
                cb.equal(liftingRoot.get("oilFieldId"), oilFieldId),
    ...
    @Override
    public double getCorporationProceed(Long pscId, Long oilFieldId, int year, int month) {
        CriteriaBuilder cb = getEntityManager().getCriteriaBuilder();
        CriteriaQuery<Number> cq = cb.createQuery(Number.class);
        Root<Lifting> liftingRoot = cq.from(entityClass);
    ...
    @Override
    public double getContractorProceed(Long pscId, Long oilFieldId, int year, int month) {
        CriteriaBuilder cb = getEntityManager().getCriteriaBuilder();
        CriteriaQuery<Number> cq = cb.createQuery(Number.class);
        Root<Lifting> liftingRoot = cq.from(entityClass);
    ...
    @Override
    public double getMonthlyIncome(Long pscId, Long oilFieldId, int year, int month) {
        CriteriaBuilder cb = getEntityManager().getCriteriaBuilder();
        CriteriaQuery<Number> cq = cb.createQuery(Number.class);
        Root<Lifting> liftingRoot = cq.from(entityClass);
...
//
    ...
    @Override
    public double getProceedToDate(Long pscId, Long oilFieldId, int year, int month) {
        CriteriaBuilder cb = getEntityManager().getCriteriaBuilder();
        CriteriaQuery<Number> cq = cb.createQuery(Number.class);
        Root<Lifting> liftingRoot = cq.from(entityClass);
    ...
    @Override
    public double getGrossIncome(Long pscId, Long oilFieldId, int year, int month) {
        CriteriaBuilder cb = getEntityManager().getCriteriaBuilder();
        CriteriaQuery<Number> cq = cb.createQuery(Number.class);
        Root<Lifting> liftingRoot = cq.from(entityClass);
    ...
    @Override
    public double getCashPayment(Long pscId, Long oilFieldId, int year, int month) {
        CriteriaBuilder cb = getEntityManager().getCriteriaBuilder();
        CriteriaQuery<Number> cq = cb.createQuery(Number.class);
        Root<Lifting> liftingRoot = cq.from(entityClass);
