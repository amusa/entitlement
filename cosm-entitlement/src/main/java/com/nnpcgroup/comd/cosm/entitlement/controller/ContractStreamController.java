...
public class ContractStreamController implements Serializable {
    ...
    @EJB
    private com.nnpcgroup.comd.cosm.entitlement.controller.ContractStreamFacade ejbFacade;
    ...
    private ContractStreamFacade getFacade() {
        return ejbFacade;
    }
    ...
    public ContractStream getContractStream(int id) {
