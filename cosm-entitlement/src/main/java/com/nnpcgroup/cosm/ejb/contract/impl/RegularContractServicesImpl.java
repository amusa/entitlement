 ...
 */
@Stateless
public class RegularContractServicesImpl extends ContractBaseServicesImpl<RegularContract> implements RegularContractServices{
    ...
    public RegularContractServicesImpl() {
