 ...
 * @param <E>
 */
public interface AlternativeFundingProductionEntitlementServices<T extends AlternativeFundingProductionEntitlement, E extends AlternativeFundingContract> extends JvProductionEntitlementServices<T, E> {
