 ...
 */
@Embeddable
public class JvProductionEntitlementPK extends ProductionEntitlementPK {
    ...
    public JvProductionEntitlementPK() {
    }

    public JvProductionEntitlementPK(ProductionPK productionPK, ContractPK contractPK) {
        super(productionPK);
    ...
    public int hashCode() {
        ...
        hash = 37 * hash + Objects.hashCode(this.contractId);
        hash = 37 * hash + Objects.hashCode(this.contractFiscalArrangementId);
    ...
    public boolean equals(Object obj) {
        ...
        final JvProductionEntitlementPK other = (JvProductionEntitlementPK) obj;
