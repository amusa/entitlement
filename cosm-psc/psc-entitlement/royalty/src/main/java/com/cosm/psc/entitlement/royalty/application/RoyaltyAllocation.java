...
public class RoyaltyAllocation extends Allocation {
	...
	protected RoyaltyAllocation(FiscalPeriod fiscalPeriod, ProductionSharingContractId pscId, double chargeBfw, double monthlyCharge, 
			double liftingProceed, double prevCumMonthlyCharge, double cashPayment) 
	{
