...
public class ProfitOilReady extends CosmEvent {
    ...
    public ProfitOilReady(JsonObject jsonObject) {
        this(new EventPeriod(jsonObject.getJsonObject("eventPeriod")),
                ...
                jsonObject.getJsonNumber("costOilMonthlyChargeToDate").doubleValue(),
                ...
                jsonObject.getJsonNumber("taxOilMonthlyChargeToDate F").doubleValue()
        );
    }
