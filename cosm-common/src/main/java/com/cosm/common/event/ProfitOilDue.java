...
public class ProfitOilDue extends CosmEvent {
    ...
    public ProfitOilDue(JsonObject jsonObject) {
        this(new EventPeriod(jsonObject.getJsonObject("eventPeriod")),
                jsonObject.getString("pscId"),
                jsonObject.getJsonNumber("profitOil").doubleValue(),
                jsonObject.getJsonNumber("corporationMonthlyCharge").doubleValue(),
                jsonObject.getJsonNumber("corporationMonthlyChargeToDate").doubleValue(),
                jsonObject.getJsonNumber("corporationProfitOilBroughtForward").doubleValue(),
                jsonObject.getJsonNumber("corporationProfitOilReceived").doubleValue(),
                jsonObject.getJsonNumber("corporationProfitOilCarriedForward").doubleValue(),
                jsonObject.getJsonNumber("contractorMonthlyCharge").doubleValue(),
                jsonObject.getJsonNumber("contractorMonthlyChargeToDate").doubleValue(),
                jsonObject.getJsonNumber("contractorProfitOilBroughtForward").doubleValue(),
                jsonObject.getJsonNumber("contractorProfitOilReceived").doubleValue(),
                jsonObject.getJsonNumber("contractorProfitOilCarriedForward").doubleValue()
        );
    }
