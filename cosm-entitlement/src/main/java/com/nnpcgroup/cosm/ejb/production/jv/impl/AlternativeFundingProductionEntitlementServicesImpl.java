 ...
 * @param <E>
 */
public abstract class AlternativeFundingProductionEntitlementServicesImpl<T extends AlternativeFundingProductionEntitlement, E extends AlternativeFundingContract> extends JvProductionEntitlementServicesImpl<T, E> implements AlternativeFundingProductionEntitlementServices<T, E> {

    private static final Logger LOG = Logger.getLogger(AlternativeFundingProductionEntitlementServicesImpl.class.getName());
    ...
    public AlternativeFundingProductionEntitlementServicesImpl(Class<T> entityClass) {
        super(entityClass);
    }
    ...
    @Override
    public T enrich(T production, Double netProd) throws NoRealizablePriceException {
...
//        Long sharedOilPeriod = getEntityManager().createQuery(q).getSingleResult();
        ...
        TypedQuery<Long> query = getEntityManager().createQuery(
                "SELECT COUNT(f) "
                + "FROM AlternativeFundingProductionEntitlement f  WHERE f.contract = :contract AND f.sharedOil != null", Long.class);
